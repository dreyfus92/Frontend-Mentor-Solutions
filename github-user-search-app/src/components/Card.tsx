...
export const Card = ({
  ...
  return (
    <div className="w-full h-auto p-[24px] text-[13px] text-[#4B6A9B] bg-white mt-[16px] rounded-[15px] shadow-[0_16px_30px_-10px_rgba(70,96,187,0.198567)]">
      <div>
        <div className="flex justify-start">
          <div>
            <img
              className="rounded-full w-[70px] mr-[19px]"
              src={avatar_url}
              alt="pfp"
            />
          </div>
          <div>
            ...
            <p>{`@${login}`}</p>
            <p className="text-[#697C9A]">{formattedDate}</p>
          </div>
        </div>
        <p className="text-left mb-[23px] w-[279px] mt-[33px] leading-5">
          {bio ??
            "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros."}
        </p>
        <div className="grid grid-cols-3 w-[279px] rounded-[10px] bg-[#F6F8FF] py-[18px] px-[15px]">
          <h3 className="text-[11px] text-[#4B6A9B] text-center order 1">
            Repos
          </h3>
          <p className="text[16px] text-black text-center font-bold order-4">
            {public_repos}
          </p>
          <h3 className="text-[11px] text-[#4B6A9B] text-center order-2">
            Followers
          </h3>
          <p className="text[16px] text-black text-center font-bold order-5">
            {followers}
          </p>
          <h3 className="text-[11px] text-[#4B6A9B] text-center order-3">
            Following
          </h3>
          <p className="text[16px] text-black text-center font-bold order-6">
            {following}
          </p>
        </div>
        <div className="mt-[24px] text-[13px] text-[#4B6A9B]">
          <div className="flex mb-[16px]">
            ...
            <p className="ml-[13px]">{location}</p>
          </div>
          <div className="flex mb-[16px]">
            ...
            <a href={`${blog}`} className="ml-[13px] hover:underline">
              {blog}
            </a>
          </div>
          <div className="flex mb-[16px]">
            ...
            <p className="ml-[13px]">{twitter_username ?? "not available"}</p>
          </div>
          <div className="flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
              <path
