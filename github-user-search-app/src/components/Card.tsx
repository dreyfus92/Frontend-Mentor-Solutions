...
export const Card = ({
  ...
  return (
    <div
      className={`w-full h-auto p-[24px] text-[13px] text-[#4B6A9B] ${
        isDark
          ? "bg-[#1E2A47]"
      ...
      <div>
        <div className="flex justify-start">
          ...
          <div>
            ...
            <p className="text-[#0079FF]">{`@${login}`}</p>
            <p className={`${isDark ? "text-white" : "text-[#697C9A]"} m`}>
              {formattedDate}
            </p>
          </div>
        </div>
        <p
          className={`text-left mb-[23px] w-[279px] mt-[33px] leading-5 ${
            isDark ? "text-white" : ""
          }`}
        >
          {bio}
        ...
        <div
          className={`grid grid-cols-3 gap-2 w-[279px] rounded-[10px] ${
            isDark ? "bg-[#141D2F] text-white" : "bg-[#F6F8FF]"
          } py-[18px] px-[15px] text-center text-[11px]`}
        >
        ...
        >
          ...
          <div className="flex mb-[16px]">
            ...
            <a
              href={`${blog}`}
              target="_blank"
              className="ml-[13px] hover:underline"
            >
              {blog}
            </a>
          </div>
          <div className="flex mb-[16px]">
            ...
            <p
              className={`ml-[13px] ${
                twitter_username === null ? "text-[#4B6A9B]" : "text-white"
              }`}
            >
